    ...
    app
        ...
        .post('/events/:eventId/attendees', {
            ...
            if (attendeeFromEmail !== null) {
                // return reply.status(400).send('This e-mail is already registered for this event.')
            ...
            if (event?.maximumAttendees && amountOfAttendeeForEvent == event.maximumAttendees) {
                // return reply.status(400).send('The maximum number of attendees for this event has been reached')
